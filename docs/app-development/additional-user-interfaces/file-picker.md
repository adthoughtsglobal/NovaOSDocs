...
Here, we use the [OL protocol](../the-open-launch-protocol.md) to launch the application with the data, which has some parameters.
...
More: [greenflag](../timing.md), [myWindow](../controlling-your-window.md).
{% endhint %}
